...
int main(int argc, char **argv) {
    ...
    if (rank == 0) {
        ...
        // Comprobar que el número de filas sea mayor o igual a la cantidad de procesos
        if (rows < size) {
            printf("El número de filas debe ser mayor o igual a la cantidad de procesos.\n");
